...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(54, 60, 274, 42);
		...
		lblValor.setBounds(72, 303, 222, 14);
		...
		txtValor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(!txtValor.getText().isEmpty()) {
					...
					txtValor.setText("$ Digite el precio");
				}			
		...
		txtValor.setBounds(117, 327, 166, 33);
		txtValor.setFont(new Font("Dialog", Font.BOLD, 13));
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				// mandar al controlador todo?

			boolean validarvalor = validacionString.isNumeric(txtValor.getText());		
									
				boolean validarFech = ReservasView.txtFechaEntrada.getDate() != null &&
							ReservasView.txtFechaSalida.getDate() != null;
			
			
				if (validarFech && validarvalor) {	
					
					// guardarReserva();

					var reserva = new Reserva( //creacion de objeto de tipo reserva
							
						validacionString.getDate(txtFechaEntrada),
						validacionString.getDate(txtFechaSalida),
						Integer.valueOf(txtValor.getText()),
						txtFormaPago.getSelectedItem().toString()
						
						);
				
				reservaContoller.guardarReserva(reserva);			
				this.limpiarReserva();
				...
				// recibir el ID
				//registro.txtNreserva.setText(""+reservaContoller.getIdReserva());
			...
			private void limpiarReserva() {
				...
				txtFechaEntrada = null;
				txtFechaSalida = null;
				txtValor.setText("$ Digite el precio");
				txtFormaPago.setSelectedItem(0);
			}
		...
		JLabel sig_lb = new JLabel("Siguiente");
		sig_lb.setFont(new Font("Arial", Font.BOLD, 14));
		sig_lb.setBounds(18, 5, 85, 25);
		btnsiguiente.add(sig_lb);
