...
public class MenuPrincipal extends JFrame {
	 ...
	 * es posible quitar el Main y correrlo en otra clase
	 */
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Emmanuel para el  desafio Hotel - Alura © 2023");
		lblCopyR.setBounds(147, 10, 479, 19);
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			(null, "¿Está seguro? de salir de la aplicación", "!Aviso!",JOptionPane.YES_NO_OPTION);
